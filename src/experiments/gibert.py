...
for d in datasets:
    ...
    opt = {'dataset': d, 'datapath': 'data/',
            'model': 'bert_inject_embd','bert_update':True,'bert_cased':False,
            ...
            'scaling_factor':None,  'scaling_vector':0.0, 'gating':False
            }
    todo.append(opt)
...
if __name__ == '__main__':
    ...
    for i,opt in enumerate(todo):
        ...
        opt = model(data, opt, logfile='gibert.json', print_dim=True)
